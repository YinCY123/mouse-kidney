...
plotTSNE(sces, 
    ...
    guides(size = guide_legend(override.aes = list(point_size = 3)))


ggsave("harmony_TSNE_cell_type.pdf")
ggsave("harmony_TSNE_location.pdf")
ggsave("harmony_TSNE_datasets.pdf")
