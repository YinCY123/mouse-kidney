...
neurons_ligands$gene_b_ligand <- ifelse(is.na(neurons_ligands$gene_b_ligand), "ENSG00000170835", neurons_ligands$gene_b_ligand)
...
ligand_list <- split(neurons_ligands$gene_b_ligand, neurons_ligands$cell_pair_ids) %>% 
