...
ggsave("../data/kidney/kidney-map/results/cell_cell_communication/sympathetic_neuron_top_ligands_receptors_expression.pdf", 
       width = 25, height = 20)
```
...
neurons_receptors_top_list %>% lapply(function(x){
    x %>% rowwise() %>% 
...
neurons_receptors_top_list[[1]] %>% 
    ...
    geom_point(aes(size = gene_b_ligand_expression)) +
    ...
    theme(axis.text.x = element_text(angle = -60, hjust = 1, size = 6), 
          ...
          panel.grid.major = element_line(linetype = 2, linewidth = 0.2))
```
