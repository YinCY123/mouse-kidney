...
```{r}
fmarker1 %>% names
fmarker1[[5]] %>% rownames() %>% head(50) %>% idconv(from_type = "GENEID", to_type = "SYMBOL", db = "mouse")
idconv("ENSMUSG00000036896", from_type = "GENEID", to_type = "SYMBOL", db = "mouse")
```
...
level1_markers <- list(
    ...
    "LOH" = c("Slc12a1", "Sptssb", "Slc5a3", "Bok"), 
    "Distal Tubule" = c("Slc12a3", "Calb1", "Pgam2", "Pvalb", 
                        "Tmem52b", "Clcnkb", "Kcnj1", "Emx1", "Klk1"),
    "Collecting Duct" = c("Aqp2", "Aqp3", "Aqp4", "Avpr2", "Hsd11b2", 
                          "Spink8", "Ptger1", "Muc1", "Muc20"),
    "Interstitial" = c("Selenop", "Sepp1", "Cdkn1c", "Synpo", "Gpx4-ps2", 
                       "Synpo", "Clic3", "Mafb", "H2-Q6", "Dpp4", "Tcf21"),
